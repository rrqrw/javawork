...
class Eagle extends Animal{
	...
	public void flying() {
		System.out.println("독수리가 날개를 펴고 멀리날아갑니다.");
	}
...
public class AnimalTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("지식형으로 다운 캐스팅");
		//크기가 3인 Animal 인스턴스를 저장할 배열생성
		Animal[] animals = new Animal[3];
		...
		for(int i=0; i<animals.length; i++) { //배열을 순화하면서 
			Animal animal = animals[i]; // 0번인덱스 부터 객체 저장
